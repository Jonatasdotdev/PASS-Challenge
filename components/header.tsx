  ...
  return (
    <header className="sticky top-0 z-10 w-full border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
      <div className="flex h-16 items-center">
        ...
        <div className={`flex items-center justify-between flex-1 min-w-0 transition-all duration-200 ${
          isCollapsed ? 'gap-4 px-4' : 'gap-4 px-2'
        }`}>
          {/* Center - Search Bar */}
          <div className={`flex justify-center transition-all duration-200 ${
            isCollapsed ? 'flex-1 max-w-lg mx-4' : 'flex-1 max-w-xs mx-1'
          }`}>
          ...
          {/* Right side - Actions */}
          <div className={`flex items-center flex-shrink-0 transition-all duration-200 ${
            isCollapsed ? 'gap-2' : 'gap-1'
          }`}>
            {/* Language Selector - Hide on very small screens */}
            <div className={`hidden ${isCollapsed ? 'sm:block' : 'lg:block'}`}>
